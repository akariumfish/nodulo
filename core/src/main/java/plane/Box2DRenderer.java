...
//	public SpriteBatch batch;
	...
	public Box2DRenderer (Applet a) {
		this(a, true, true, false, true, false, true);
	}

	public Box2DRenderer (Applet a, boolean drawBodies, boolean drawJoints, boolean drawAABBs, boolean drawInactiveBodies,
...
//			renderer.line(lv.x, lv.y, v.x, v.y);
			app.line(lv.x, lv.y, v.x, v.y);
			lv.set(v);
		}
//		renderer.line(f.x, f.y, lv.x, lv.y);
//		renderer.line(center.x, center.y, 0, center.x + axis.x * radius, center.y + axis.y * radius, 0);
		app.line(f.x, f.y, lv.x, lv.y);
		app.line(center.x, center.y, center.x + axis.x * radius, center.y + axis.y * radius);
	}
...
//		if (closed) renderer.line(f.x, f.y, lv.x, lv.y);
		if (closed) app.line(f.x, f.y, lv.x, lv.y);
	}
